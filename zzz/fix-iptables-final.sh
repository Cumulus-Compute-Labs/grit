#!/bin/bash
# Rebuild image WITHOUT iptables - rely on host's iptables via mount

set -e

cd /tmp/grit-build

echo "=== Step 1: Update Dockerfile WITHOUT iptables ==="
...
# Use minimal image - NO iptables installed (will use host's via mount)
...
echo ""
echo "=== Step 3: Import to containerd ==="
...
echo ""
echo "=== Step 4: Update ConfigMap to mount host /usr/sbin directly over container's ==="
...
echo ""
echo "=== Step 5: Restart grit-manager ==="
...
echo ""
echo "✅ Done! Using minimal image with host's iptables mounted directly to /usr/sbin"
